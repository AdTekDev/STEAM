...
app.get("/sanpham", (req, res) => {
    let dssp = [
        { id:1, title: "HP la con duong", brief : "la mot cuon sach tich cuc ..", linkImg : "/image/001.jpg"},
        { id:2, title: "con duong tien toi hanh phuc", brief : "la mot cuon sach tich phan ..", linkImg : "/image/002.jpg"},
        { id:3, title: "HP san pham may in", brief : "may in tot ..", linkImg : "/image/003.jpg"}
    ];
